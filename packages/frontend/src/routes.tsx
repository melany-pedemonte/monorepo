...
const AccountV2 = Loadable(lazy(() => import("./pages/accounts/account-v2")));
...
const ProfileV2 = Loadable(lazy(() => import("./pages/profiles/profile-v2")));
...
// pricing
const TodoList = Loadable(lazy(() => import("./pages/todo-list")));
...
const ChatV2 = Loadable(lazy(() => import("./pages/chats/chat-v2")));
...
const ProjectV3 = Loadable(lazy(() => import("./pages/projects/project-v3")));
...
const dashboardRoutes = [
  { path: "", element: <LearningManagement /> },
  { path: "job-management", element: <JobManagement /> },
  { path: "sales", element: <Sales /> },
  { path: "sales-v2", element: <SalesV2 /> },
  { path: "crm", element: <CRM /> },
  { path: "saas", element: <SaaS /> },
  { path: "sub-child-v1", element: <SalesV2 /> },
  { path: "sub-child-v2", element: <ProjectManagement /> },
  { path: "sub-child-v3", element: <ProjectManagementV2 /> },
  { path: "project-management", element: <ProjectManagement /> },
  { path: "project-management-v2", element: <ProjectManagementV2 /> },

  { path: "account", element: <Account /> },
  { path: "account-v2", element: <AccountV2 /> },

  { path: "profile", element: <Profile /> },
  { path: "profile-v2", element: <ProfileV2 /> },

  { path: "data-table-v2", element: <DataTableV2 /> },

  { path: "add-user", element: <AddUser /> },
  { path: "user-list", element: <UserList /> },
  { path: "user-list-v2", element: <UserListV2 /> },
  { path: "user-grid", element: <UserGrid /> },
  { path: "user-grid-v2", element: <UserGridV2 /> },
  { path: "contact-list", element: <ContactList /> },
  { path: "contact-grid", element: <ContactGrid /> },

  { path: "invoice-list", element: <InvoiceList /> },
  { path: "invoice-list-v2", element: <InvoiceList2 /> },
  { path: "create-invoice", element: <CreateInvoice /> },
  { path: "create-invoice-v2", element: <CreateInvoice2 /> },
  { path: "invoice-details", element: <InvoiceDetails /> },
  { path: "invoice-details-v2", element: <InvoiceDetails2 /> },

  { path: "project-v1", element: <ProjectV1 /> },
  { path: "project-v2", element: <ProjectV2 /> },
  { path: "project-v3", element: <ProjectV3 /> },
  { path: "team-member", element: <TeamMember /> },
  { path: "project-details", element: <ProjectDetails /> },

  { path: "shop", element: <Shop /> },
  { path: "shop-v2", element: <ShopV2 /> },
  ...
  { path: "payment-complete-v2", element: <PaymentCompleteV2 /> },
